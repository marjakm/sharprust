...
// 1400 - 1630 is good
#define DRIVING_MIN_PULSE 1370
#define DRIVING_NORM_B 1370
#define DRIVING_NEUTRAL 1500
#define DRIVING_NORM_F 1640
#define DRIVING_MAX_PULSE 1730
...
#define BACKING_SECONDS 0.4
#define STUCK_BEFORE_BACKING_SECONDS 0.6
#define MOUNTAIN_CLIMB_SECONDS 0.6
